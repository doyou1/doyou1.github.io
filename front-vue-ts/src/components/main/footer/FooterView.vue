  ...
  <div>
    <section id="footer-wrap">
      <div class="footer-container">
        <div
          v-for="(footerMenu, index) in footerMenuList"
          :key="index"
          class="footer-col"
        >
          <h4>{{ footerMenu.footerTitle }}</h4>
          <ul>
            <!-- footerMenu의 각 footerDetail에 대해 반복 -->
            <li
...
$testFillBackgroundColor: #e0e0e0;
...
#footer-wrap,
.footer-container {
  --footer-fill-backgroundcolor: #f9f9f9;
  --footer-text-h4: #213547;
  --footer-text-link: rgba(60, 60, 60, 0.7);
}
...
#footer-wrap {
  background-color: var(--footer-fill-backgroundcolor);
  padding: 42px 32px;
}
