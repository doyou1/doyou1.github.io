...
<template>
    <div class="flex justify-between items-center pl-8 pr-3 py-1 dark:bg-black delay-50">
        <div class="flex">
            <!-- home logo -->
            ...
            <div class="flex">
                <button type="button" class="flex group">
                    ...
                    <span class="mx-1 flex w-auto border dark:border-[#ebebeb99] group-hover:dark:border-[#42b883] rounded px-1.5 gap-0.5 text-xs self-center">
